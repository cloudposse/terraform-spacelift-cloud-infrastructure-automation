...
| <a name="input_labels"></a> [labels](#input\_labels) | A list of labels to attach to each stack | `set(string)` | `[]` | no |
...
| <a name="input_stack_context_description"></a> [stack\_context\_description](#input\_stack\_context\_description) | Description of global stack context | `string` | `"Stack global variables"` | no |
| <a name="input_stack_context_name"></a> [stack\_context\_name](#input\_stack\_context\_name) | Name of global stack context | `string` | `"Global stack variables"` | no |
