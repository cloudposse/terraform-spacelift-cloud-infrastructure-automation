...
| <a name="input_additional_policy_ids"></a> [additional\_policy\_ids](#input\_additional\_policy\_ids) | List of additional (existing) policy IDs to attach to all Spacelift stacks | `list(string)` | `[]` | no |
...
| <a name="input_policies_attach"></a> [policies\_attach](#input\_policies\_attach) | List of default policies to attach to all Spacelift stacks | `list(string)` | <pre>[<br>  "git_push.default",<br>  "plan.default",<br>  "trigger.dependencies"<br>]</pre> | no |
| <a name="input_policies_create"></a> [policies\_create](#input\_policies\_create) | List of default policies to create in Spacelift (these policies will not be attached to Spacelift stacks by default, use `var.policies_attach`) | `list(string)` | <pre>[<br>  "access.default",<br>  "git_push.default",<br>  "plan.default",<br>  "trigger.dependencies",<br>  "trigger.retries"<br>]</pre> | no |
