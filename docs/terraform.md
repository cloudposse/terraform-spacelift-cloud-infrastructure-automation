...
| <a name="input_default_policies_enabled"></a> [default\_policies\_enabled](#input\_default\_policies\_enabled) | List of default policies to attach to all Spacelift stacks | `list(string)` | <pre>[<br>  "access.default",<br>  "git_push.default",<br>  "plan.default",<br>  "trigger.dependencies"<br>]</pre> | no |
