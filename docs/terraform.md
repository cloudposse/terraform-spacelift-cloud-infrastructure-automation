...
| <a name="input_trigger_administrative_enabled"></a> [trigger\_administrative\_enabled](#input\_trigger\_administrative\_enabled) | Flag to enable/disable the global administrative trigger | `bool` | `false` | no |
