...
| <a name="input_spacelift_stacks_override"></a> [spacelift\_stacks\_override](#input\_spacelift\_stacks\_override) | A map of spacelift\_stacks to override the stacks in the module | `any` | `{}` | no |
