...
# spacelift-space <a href="https://cpco.io/homepage?utm_source=github&utm_medium=readme&utm_campaign=cloudposse/terraform-spacelift-cloud-infrastructure-automation&utm_content="><img align="right" src="https://cloudposse.com/logo-300x69.svg" width="150" /></a>
...
| <a name="input_description"></a> [description](#input\_description) | Description of the space | `string` | `null` | no |
...
| <a name="input_inherit_entities_from_parent"></a> [inherit\_entities\_from\_parent](#input\_inherit\_entities\_from\_parent) | Flag to indicate whether this space inherits read access to entities from the parent space. | `bool` | `false` | no |
...
| <a name="input_labels"></a> [labels](#input\_labels) | List of labels to add to the space. | `set(string)` | `[]` | no |
